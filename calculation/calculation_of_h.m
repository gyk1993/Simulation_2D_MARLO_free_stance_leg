...
matlabFunction(h, 'file', ['../util/h_functions/get_h.m'], 'vars', {q,dq,alpha,theta_begin,theta_end});
matlabFunction(dh, 'file', ['../util/h_functions/get_dh.m'], 'vars', {q,dq,alpha,theta_begin,theta_end});
...
matlabFunction(hd, 'file', ['../util/h_functions/get_hd.m'], 'vars', {q,dq,alpha,theta_begin,theta_end});
matlabFunction(dhd, 'file', ['../util/h_functions/get_dhd.m'], 'vars', {q,dq,alpha,theta_begin,theta_end});