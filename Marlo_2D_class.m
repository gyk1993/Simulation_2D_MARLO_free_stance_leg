    ...
    methods
        ...
        function [D,C,G,B,DampingSpringTorque]= Dynamic_model(obj,q,dq)
            ...
            D(3,3)=2*Jcm1 + 2*Jcm2 + 2*Jcm3 + 2*Jcm4 + JcmT + 2*Jgear1 + 2*...
                ...
                sin(q1L - q2L);
            D(3,4)=Jcm1 + Jcm4 + Jgear1 + L1^2*m3 + 2*L4^2*m1 + 2*L4^2*...
                m2 + 2*L4^2*m3 + 2*L4^2*m4 + L4^2*mT + ellycm1^2*m1 + ellzcm1^2*...
                m1 + ellycm4^2*m4 + ellzcm4^2*m4 + Jrotor1*R1 - 2*L1*L4*m3 - 2*...
                L4*ellzcm1*m1 - 2*L4*ellzcm4*m4 - L4*ellzcmT*mT*cos(q1) + L4*...
                ellycmT*mT*sin(q1) - L1*L2*m3*cos(q1 - q2) + 2*L2*L4*m1*...
                cos(q1 - q2) + 2*L2*L4*m2*cos(q1 - q2) + 2*L2*L4*m3*...
                cos(q1 - q2) + L2*L4*m4*cos(q1 - q2) - L1*L4*m3*...
                cos(q1 - q1L) - L2*L4*m4*cos(q1 - q2L) + L2*L4*mT*...
                cos(q1 - q2) - L2*ellzcm1*m1*cos(q1 - q2) + L1*ellzcm3*m3*...
                cos(q1 - q2) - L4*ellzcm2*m2*cos(q1 - q2) - L4*ellzcm3*m3*...
                cos(q1 - q2) - L4*ellzcm1*m1*cos(q1 - q1L) - L4*ellzcm2*m2*...
                cos(q1 - q2L) - L4*ellzcm3*m3*cos(q1 - q2L) - L4*ellzcm4*m4*...
                cos(q1 - q1L) - L2*ellycm1*m1*sin(q1 - q2) - L1*ellycm3*m3*...
                sin(q1 - q2) + L4*ellycm2*m2*sin(q1 - q2) + L4*ellycm3*m3*...
                sin(q1 - q2) + L4*ellycm1*m1*sin(q1 - q1L) + L4*ellycm2*m2*...
                sin(q1 - q2L) + L4*ellycm3*m3*sin(q1 - q2L) + L4*ellycm4*m4*...
                sin(q1 - q1L);
            D(3,5)=Jcm2 + Jcm3 + Jgear2 + 2*L2^2*m1 + 2*L2^2*m2 + 2*L2^2*...
                m3 + L2^2*m4 + L2^2*mT + ellycm2^2*m2 + ellzcm2^2*m2 + ellycm3^2*...
                m3 + ellzcm3^2*m3 + Jrotor2*R2 - L2^2*m4*cos(q2 - q2L) - 2*L2*...
                ellzcm2*m2 - 2*L2*ellzcm3*m3 - L2*ellzcmT*mT*cos(q2) + L2*...
                ellycmT*mT*sin(q2) - L1*L2*m3*cos(q1 - q2) + 2*L2*L4*m1*...
                cos(q1 - q2) + 2*L2*L4*m2*cos(q1 - q2) + 2*L2*L4*m3*...
                cos(q1 - q2) + L2*L4*m4*cos(q1 - q2) - L1*L2*m3*...
                cos(q2 - q1L) + L2*L4*mT*cos(q1 - q2) - L2*ellzcm1*m1*...
                cos(q1 - q2) + L1*ellzcm3*m3*cos(q1 - q2) - L4*ellzcm2*m2*...
                cos(q1 - q2) - L4*ellzcm3*m3*cos(q1 - q2) - L2*ellzcm1*m1*...
                cos(q2 - q1L) - L2*ellzcm2*m2*cos(q2 - q2L) - L2*ellzcm3*m3*...
                cos(q2 - q2L) - L2*ellzcm4*m4*cos(q2 - q1L) - L2*ellycm1*m1*...
                sin(q1 - q2) - L1*ellycm3*m3*sin(q1 - q2) + L4*ellycm2*m2*...
                sin(q1 - q2) + L4*ellycm3*m3*sin(q1 - q2) + L2*ellycm1*m1*...
                sin(q2 - q1L) + L2*ellycm2*m2*sin(q2 - q2L) + L2*ellycm3*m3*...
                sin(q2 - q2L) + L2*ellycm4*m4*sin(q2 - q1L);
            D(3,6)=Jcm1 + Jcm4 + Jgear1 + L1^2*m3 + ellycm1^2*m1 + ellzcm1^2*...
                m1 + ellycm4^2*m4 + ellzcm4^2*m4 + Jrotor1*R1 - L1*L2*m3*...
                cos(q2 - q1L) - L1*L4*m3*cos(q1 - q1L) - L2*ellzcm1*m1*...
                cos(q2 - q1L) - L4*ellzcm1*m1*cos(q1 - q1L) - L2*ellzcm4*m4*...
                cos(q2 - q1L) - L4*ellzcm4*m4*cos(q1 - q1L) + L1*ellzcm3*m3*...
                cos(q1L - q2L) + L2*ellzcm4*m4*cos(q1L - q2L) + L2*ellycm1*m1*...
                sin(q2 - q1L) + L4*ellycm1*m1*sin(q1 - q1L) + L2*ellycm4*m4*...
                sin(q2 - q1L) + L4*ellycm4*m4*sin(q1 - q1L) - L1*ellycm3*m3*...
            ...
            D(3,7)=Jcm2 + Jcm3 + Jgear2 + L2^2*m4 + ellycm2^2*m2 + ellzcm2^2*...
                ...
                cos(q2 - q2L) - L2*L4*m4*cos(q1 - q2L) - L2*ellzcm2*m2*...
                cos(q2 - q2L) - L4*ellzcm2*m2*cos(q1 - q2L) - L2*ellzcm3*m3*...
            ...
            D(4,2)=2*L4*m1*sin(q1 + qT) - L1*m3*sin(q1 + qT) + 2*L4*m2*...
                ...
                mT*sin(q1 + qT) + ellycm1*m1*cos(q1 + qT) + ellycm4*m4*...
                cos(q1 + qT) - ellzcm1*m1*sin(q1 + qT) - ellzcm4*m4*sin(q1 + qT);
            D(4,3)=Jcm1 + Jcm4 + Jgear1 + L1^2*m3 + 2*L4^2*m1 + 2*L4^2*...
                m2 + 2*L4^2*m3 + 2*L4^2*m4 + L4^2*mT + ellycm1^2*m1 + ellzcm1^2*...
                m1 + ellycm4^2*m4 + ellzcm4^2*m4 + Jrotor1*R1 - 2*L1*L4*m3 - 2*...
                L4*ellzcm1*m1 - 2*L4*ellzcm4*m4 - L4*ellzcmT*mT*cos(q1) + L4*...
                ellycmT*mT*sin(q1) - L1*L2*m3*cos(q1 - q2) + 2*L2*L4*m1*...
                ...
                sin(q1 - q2L) + L4*ellycm3*m3*sin(q1 - q2L) + L4*ellycm4*m4*...
                sin(q1 - q1L);
            D(4,4)=Jcm1 + Jcm4 + Jgear1 + Jrotor1*R1^2 + L1^2*m3 + 2*L4^2*...
                m1 + 2*L4^2*m2 + 2*L4^2*m3 + 2*L4^2*m4 + L4^2*mT + ellycm1^2*...
                m1 + ellzcm1^2*m1 + ellycm4^2*m4 + ellzcm4^2*m4 - 2*L1*L4*m3 - 2*...
                L4*ellzcm1*m1 - 2*L4*ellzcm4*m4;
            ...
            D(5,2)=2*L2*m1*sin(q2 + qT) + 2*L2*m2*sin(q2 + qT) + 2*L2*m3*...
                ...
                m2*cos(q2 + qT) + ellycm3*m3*cos(q2 + qT) - ellzcm2*m2*...
                sin(q2 + qT) - ellzcm3*m3*sin(q2 + qT);
            D(5,3)=Jcm2 + Jcm3 + Jgear2 + 2*L2^2*m1 + 2*L2^2*m2 + 2*L2^2*...
                m3 + L2^2*m4 + L2^2*mT + ellycm2^2*m2 + ellzcm2^2*m2 + ellycm3^2*...
                m3 + ellzcm3^2*m3 + Jrotor2*R2 - L2^2*m4*cos(q2 - q2L) - 2*L2*...
                ellzcm2*m2 - 2*L2*ellzcm3*m3 - L2*ellzcmT*mT*cos(q2) + L2*...
                ellycmT*mT*sin(q2) - L1*L2*m3*cos(q1 - q2) + 2*L2*L4*m1*...
            ...
            D(5,4)=2*L2*L4*m1*cos(q1 - q2) - L1*L2*m3*cos(q1 - q2) + 2*L2*L4*...
                ...
                sin(q1 - q2) - L1*ellycm3*m3*sin(q1 - q2) + L4*ellycm2*m2*...
                sin(q1 - q2) + L4*ellycm3*m3*sin(q1 - q2);
            D(5,5)=Jcm2 + Jcm3 + Jgear2 + Jrotor2*R2^2 + 2*L2^2*m1 + 2*L2^2*...
                m2 + 2*L2^2*m3 + L2^2*m4 + L2^2*mT + ellycm2^2*m2 + ellzcm2^2*...
                m2 + ellycm3^2*m3 + ellzcm3^2*m3 - 2*L2*ellzcm2*m2 - 2*L2*...
                ellzcm3*m3;
...
%             B(7,4)=1;
        ...
        function [Ds,Cs,Gs,Bs]=shrink_model(obj,q,dq)
        ...
        function [EL,dEL]=get_EL(obj,x)
            ...
            dq1=x(8);	dq2=x(9);	dq3=x(10);  dq4=x(11);  dq5=x(12);  dq6=x(13);  dq7=x(14);
            EL=[                                                                       1,                                                                       0
                0,                                                                       1
